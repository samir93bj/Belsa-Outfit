<div wire:ignore.self class="modal fade" id="CreateClientModal" tabindex="-1" aria-labelledby="CreateClientModal" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="CreateClientModal">Registrar Nuevo Cliente</h5>
        ...
        <div class="container-fluid">   
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-12">
                    ...
                    <input type="text" name="description" class="form-control" placeholder="Descripcion" wire:model.defer="description">
