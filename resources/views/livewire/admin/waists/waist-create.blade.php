<div wire:ignore.self class="modal fade" id="CreateWaistModal" tabindex="-1" aria-labelledby="CreateWaistModal" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="CreateWaistModal">Crear nuevo Talle</h5>
