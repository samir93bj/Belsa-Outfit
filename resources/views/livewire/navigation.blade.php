<nav class="bg-gray-800" x-data="{open : false}">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              ...
              @foreach ($categories as $category) 
                <a href="{{route('admin.categories.edit',$category)}}" class="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">{{ $category->name }}</a>
              @endforeach
    ...
    <div class=" md:hidden" x-show="open" x-on:click.away="open = false">
      <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
       ...
       @foreach ($categories as $category)
        <a href="{{route('admin.categories.edit',$category)}}" class="text-gray-300 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium">{{ $category->name }}</a>
       @endforeach
